...
return [
    ...
    'url' => env('APP_URL', 'https://example.invalid'), 'frontend_url' => env('FRONTEND_URL', 'https://example.invalid'), 'timezone' => env('APP_TIMEZONE', 'Asia/Kolkata'), 'locale' => env('APP_LOCALE', 'en'),
