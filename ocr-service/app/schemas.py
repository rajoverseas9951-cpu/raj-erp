...
class RCFields(BaseModel):
    ...
    emission_norms: str | None = None
    colour: str | None = None
    manufacturing_month_year: str | None = None
    manufacturing_month: str | None = None
    manufacturing_year: str | None = None
    seating_capacity: str | None = None
    cubic_capacity: str | None = None
    horse_power: str | None = None
    wheel_base: str | None = None
    number_of_cylinders: str | None = None
