...
export type VehicleModule = 'vehicle_details'|'insurance'|'puc'|'fitness'|'permit'|'tax'|'counter_tax'|'hsrp'|'sld'|'rto_process'|'transfer'|'payment'|'agent_payment'|'other_payment';
