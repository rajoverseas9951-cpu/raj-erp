...
function tone(value?:string){const key=(value??"not_added").toLowerCase();if(["active","valid","completed","renewed","added"].includes(key))return "bg-emerald-50 text-emerald-700 ring-emerald-200";if(["due","expiring","pending","in_progress"].includes(key))return "bg-amber-50 text-amber-700 ring-amber-200";if(["expired","missing","cancelled","critical"].includes(key))return "bg-rose-50 text-rose-700 ring-rose-200";return "bg-slate-100 text-slate-600 ring-slate-200"}
