  ...
  return <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_20px_60px_-42px_rgba(15,23,42,.5)]">
    <div className="space-y-4 border-b border-slate-100 p-4 sm:p-5">
      <div className="grid gap-3 lg:grid-cols-[minmax(280px,1fr)_180px_auto]">
        ...
        <div className="flex flex-wrap gap-2 lg:justify-end"><a className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-bold hover:border-blue-300 hover:text-blue-700" href={`/api/v1/vehicles/export${exportQuery?`?${exportQuery}`:""}`}>Excel</a><a className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-bold hover:border-blue-300 hover:text-blue-700" href={`/api/v1/vehicles/export?${exportQuery?`${exportQuery}&`:""}format=pdf`}>PDF</a><button type="button" onClick={()=>window.print()} className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-bold hover:border-blue-300 hover:text-blue-700">Print</button></div>
      </div>
