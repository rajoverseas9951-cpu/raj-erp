...
const reports=[
  ...
  ['RTO Work Report','All RTO, tax, permit, PUC, fitness, SLD and transfer work.','/reports/rto-work','RT'],
  ['RTO Profit Report','Category-wise billing, cost and net profit.','/reports/rto-profit','RP'],
  ...
  ['Day Book','Chronological voucher and transaction register.','/reports/day-book','DB'],
] as const;
...
export default function ReportsPage(){
  ...
  return <main className="min-h-screen bg-[#f3f7fc] p-4 text-slate-950 md:p-6">
    <div className="mx-auto max-w-[1600px] space-y-6">
      <section className="overflow-hidden rounded-[32px] bg-gradient-to-br from-[#06132f] via-[#103579] to-[#2469e8] p-7 text-white shadow-2xl md:p-9"><div className="flex flex-wrap items-end justify-between gap-5"><div><p className="text-xs font-black uppercase tracking-[.26em] text-cyan-200">Business Intelligence</p><h1 className="mt-2 text-4xl font-black">Report Master</h1><p className="mt-2 max-w-3xl text-sm text-blue-100">Insurance separate reporting. RTO business ke andar RTO Process, PUC, Fitness, Permit, Tax, Counter Tax, HSRP, SLD aur Transfer Work consolidated hain.</p></div><Link href="/accounts" className="rounded-2xl border border-white/20 bg-white/10 px-5 py-3 font-black backdrop-blur">Open Accounts</Link></div></section>
